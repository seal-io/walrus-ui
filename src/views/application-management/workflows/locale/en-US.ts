export default {
  ...
  'applications.workflow.table.startTime': 'Start Time',
  ...
  'workflow.task.form.deployservice': 'Deploy Resource',
  ...
  'workflow.task.form.info.service': 'Resource Configuration',
  ...
  'workflow.table.run.config': 'Run configuration',
