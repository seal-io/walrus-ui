export default {
  ...
  'applications.applications.clone': '克隆资源',
  ...
  'applications.applications.form.useTemplate': '使用模板',
  ...
  'applications.applications.history.detail': '执行详情',
  'applications.applications.history.latest': '最新执行详情',
  ...
  'applications.environment.table.status': '资源状态',
  ...
  'applications.environment.graph.show': '显示组件',
  'applications.environment.graph.hide': '隐藏组件',
  ...
  'resource.revisons.table.duration': '运行时长',
  ...
  'resource.revisons.components.change.create': '新增',
  'resource.revisons.components.change.delete': '删除',
  'resource.revisons.components.change.update': '更新',
  'resource.revisons.components.change.nochange': '无变更',
