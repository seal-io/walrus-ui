export default {
  ...
  'applications.applications.history.rollbackinstance': '实例回滚',
  ...
  'applications.projects.authorize.title': '项目授权',
  'applications.projects.authorize.account': '请选择账户',
  'applications.projects.authorize.role': '请选择角色',
