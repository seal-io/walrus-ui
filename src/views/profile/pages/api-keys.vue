<template>
  <div class="container">
    ...
    <NewApiKeys v-model:show="show" @tokenSave="handleSave"></NewApiKeys>
  </div>
</template>
...
<script lang="ts" setup>
  ...
  import NewApiKeys from '../components/new-api-keys.vue';
  import { queryTokens, deleteTokens, FormDataType } from '../api';
