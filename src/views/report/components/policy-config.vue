    ...
    <a-card class="general-card q-s-w-card" :bordered="true">
      <template #title>
        <div class="violation-title-wrap">
          <div class="card-title" :size="0" fill style="min-height: 50px">
      ...
      <div class="violation-content-wrap">
        ...
        <div v-if="vulnerabilityInfo.link || vulnerabilityInfo.fileLink">
          <div class="sub title">{{ $t('report.detail.link') }}</div>
          <div
            style="
              display: flex;
              align-items: center;
          ...
          >
            ...
            >
            <div v-if="!vulnerabilityInfo.description" class="expand-btn-wrap"
              ><icon-double-down
                class="expand-btn"
        ...
        <div class="basic-info-wrap">
          <div v-if="vulnerabilityInfo.description">
...
<script lang="ts" setup>
  ...
  //   const data = props.issuesData?.artifact || {};
  //   const list = licenseArtifactConfig.map((item) => {
  //     item.value = data[item.key];
  //     return item;
  //   });
  //   return list;
