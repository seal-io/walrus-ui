...
<script lang="ts" setup>
  ...
  import { issueTrendConfig } from '../config';
  ...
  const { chartOption } = useChartOption((): any => {
    ...
    const seriesDataList = map(issueTrendConfig, (item) => {
      const valueData = find(get(props.data, 'data') || [], (sItem) => {
