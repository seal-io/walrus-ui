export default {
  ...
  'operation.connectors.detail.jsonformat': '文件格式：Google 凭据 .json 文件',
  ...
  'operation.connectors.form.region.tips': '自定义：输入您的区域代码按回车确认',
  ...
  'operation.templates.table.catalog': '模板库',
  'operation.templates.table.noncatalog': '自定义模板',
  'operation.templates.table.holder': '请输入模板',
  'operation.templates.catalogId.holder': '请选择模板库',
  ...
  'operation.templates.detail.resetTips': '您确定要重置为初始 schema 吗？',
  'operation.templates.detail.resetTitle': '重置为初始 schema',
