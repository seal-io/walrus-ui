export default {
  ...
  'operation.templates.menu': 'Modules',
  ...
  'operation.templates.table.title': 'Module List',
  'operation.templates.table.name': 'Module',
  'operation.templates.table.holder': 'please enter a module',
  'operation.templates.type.holder': 'please select a module type',
  'operation.templates.detail.edit': 'Edit Module',
  'operation.templates.detail.add': 'New Module',
  'operation.templates.detail.view': 'Module Details',
  'operation.templates.button.gpt': 'AI Draft Module',
